...
/**
 * Converts an Obs Id to the corresponding creator name. We first try to retrieve the last user who
 * changed the Obs with Obs#getChangedBy() and if that returns null, we use Obs#getCreator() to
 * retrieve the creator of the Obs
 */
